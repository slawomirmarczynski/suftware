...
def display_status():
    if(global_mistake):
        print("Test Failed: ",global_test_fail_counter)
    else:
        print("Test Passed: ", global_test_success_counter)

def display_global_status():
    print('\033[1m'+"Total tests: passed: ", global_test_success_counter, " Total tests failed: ",global_test_fail_counter)
