...
<?php // getData.php
// Performs maxent density estimation
...
$command = 'cat ' . $data_file_name . ' | ../code/maxent_1d.py';
...
if (array_key_exists('maxent_order', $_POST))
    $command .= " --order=" . sanitizeString($_POST['maxent_order']);

$command .= ' --json';

// Save last command in file. Useful for debugging purposes
$myfile = fopen("commandline/last_maxent_1d_command.sh","w");
