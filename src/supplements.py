...
#     """
#     Sanitize the data
#     :param data (set-like): user-supplied data
#     :return (np.array): cleaned user data
#     """
#     try:
...
#     try:
#         if not (isinstance(G, int) or (G is None)):
#             raise DeftError(
...
#
#     try:
#         if isinstance(G, int) and (not (G >= 2 * alpha and G <= 1000)):
#             raise DeftError(
...
#                 print('bbox: ', bbox)
#                 raise DeftError(
#                     'Input check failed. Bounding box must have length 2. Current length = %d' % len(
#                         bbox))
#     except DeftError as e:
#         print(e)
#         sys.exit(1)
...
#                     raise DeftError(
#                         'Input check failed. Bounding box must contain numbers: Bounding box entered = %s' % bbox)
#     except DeftError as e:
#         print(e)
#         sys.exit(1)
#
